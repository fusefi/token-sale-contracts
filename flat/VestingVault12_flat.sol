...
// File openzeppelin-solidity/contracts/token/ERC20/IERC20.sol@v2.0.1
...
// File openzeppelin-solidity/contracts/token/ERC20/ERC20.sol@v2.0.1
pragma solidity ^0.4.24;
...
contract ERC20 is IERC20 {
  ...
  */
  ...
  function approve(address spender, uint256 value) public returns (bool) {
    require(spender != address(0), "approve: not zero");
  ...
  function transferFrom(
    ...
    returns (bool)
  {
    require(value <= _allowed[from][msg.sender], "transferFrom: approval amount low");
  ...
  function increaseAllowance(
    ...
    returns (bool)
  {
    require(spender != address(0), "increaseAllowance: address is not zero");
  ...
  */
  function _transfer(address from, address to, uint256 value) internal {
    require(value <= _balances[from], "_transfer: less than");
    require(to != address(0), "_transfer: not zero");
...
contract VestingVault12 {
    ...
    function addTokenGrant(
        ...
        require(
            token.transferFrom(v12MultiSig, address(this), _amount),
            "transfer failed"
        );
    ...
    function removeTokenGrant(uint256 _grantId) external onlyV12MultiSig {
        Grant storage tokenGrant = tokenGrants[_grantId];
        ...
        uint256 amountNotVested = tokenGrant.amount.sub(
            tokenGrant.totalClaimed
        );
